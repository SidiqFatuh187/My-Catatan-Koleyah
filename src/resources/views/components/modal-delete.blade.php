        ...
        <form id="deleteForm" action="" method="POST">
            ...
            <div class="p-6 text-center">
               <div class="w-16 h-16 mx-auto bg-rose-50 text-rose-600 rounded-full flex items-center justify-center mb-5 border-[6px] border-white shadow-sm shadow-rose-100">
                ...
                <h3 class="text-lg font-bold text-slate-900 tracking-tight mb-2">{{ $title ?? 'Hapus Item Ini?' }}</h3>
                <p class="text-sm text-slate-500 leading-relaxed mb-8">
                    <span id="modal-item-name" class="font-semibold text-slate-700"></span> akan dihapus permanen dan tidak bisa dikembalikan.
                </p>
