...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <h2 class="text-base font-semibold text-gray-700">Tambah Kategori Baru</h2>
            <p class="text-sm text-gray-400 mt-0.5">Isi detail kategori yang ingin kamu buat.</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div class="relative">
                    <label class="block text-sm font-medium text-gray-600 mb-1.5">
                        Icon <span class="text-gray-400 font-normal">(opsional)</span>
                    </label>

                    {{-- Hidden real input sent to server --}}
                    <input type="hidden" name="icon" id="iconValue" value="{{ old('icon') }}" />
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        {{-- Info text + clear --}}
                        <div class="flex-1">
                            <div id="emojiSelectedInfo" class="hidden items-center gap-2 mb-1">
                                <span class="text-sm font-medium text-gray-700" id="emojiSelectedLabel"></span>
                                <button type="button" id="iconClearBtn"
                                    class="text-xs text-red-400 hover:text-red-600 hover:underline transition-colors">
                                    Hapus
                                </button>
                            </div>
                            <p id="emojiHint" class="text-sm text-gray-400">
                            ...
                            <p class="text-xs text-gray-300 mt-0.5">
                                ...
                                <span class="text-gray-300">lalu klik bubble</span>
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="p-3 border-b border-gray-100">
                            <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-3 py-2">
                                ...
                                <input type="text" id="emojiSearch"
                                    placeholder="Cari emoji... (ketik nama, misal: hati, api, bintang)"
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-2 mb-3">
                        ...
                        <label for="colorPicker"
                            ...
                            <input type="color" id="colorPicker" class="sr-only" value="{{ old('color', '#3B82F6') }}" />
                        </label>
                    </div>

                    <input type="hidden" name="color" id="colorValue" value="{{ old('color', '#3B82F6') }}" />

                    <div class="flex items-center gap-2">
                        <div id="colorSwatch" class="w-5 h-5 rounded-md border border-gray-200"
                            style="background-color: {{ old('color', '#3B82F6') }}"></div>
                        <span id="colorHex" class="text-xs font-mono text-gray-500">{{ old('color', '#3B82F6') }}</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex flex-col gap-4 max-w-xs">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div id="previewAvatar"
                                        class="w-10 h-10 rounded-xl flex items-center justify-center text-white text-base font-bold"
                                        style="background-color: #3B82F6">K</div>
                                    <div>
                                        <p id="previewName" class="text-sm font-semibold text-gray-700">Nama Kategori</p>
                            ...
                            <div id="previewBar" class="h-1.5 rounded-full w-full" style="background-color: #3B82F6"></div>
                        </div>
                    </div>
                </div>
